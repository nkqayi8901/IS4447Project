...
// The badge's layout is a horizontal row with the icon on the left and the category name on the right. The padding and font size are adjusted based on whether the "small" prop is true or false, allowing for flexibility in how the badge is displayed in different contexts throughout the app.
type Props = {
  name: string;
  color: string;
  icon?: string;
